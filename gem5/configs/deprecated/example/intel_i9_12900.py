...
def build_test_system(np):
    ...
    # Set specific CPU parameters for Intel i9-12900H
    for cpu in test_sys.cpu:
        if isinstance(cpu, DerivO3CPU):
            # Adjust parameters to match Intel i9-12900H specifications
            ...
            # Set fetch width to comply with DerivO3CPU limits
            cpu.fetchWidth = 12  # Set to 12 to match the compiled limit
            cpu.decodeWidth = 12
            ...
            cpu.numThreads = 1  # Set to 1 for i9-12900H (no SMT)
...
# Set default values for Intel i9-12900H
if not hasattr(args, "num_cpus") or args.num_cpus is None:
    args.num_cpus = 24  # Only set default if not provided
args.cpu_clock = "2.4GHz"  # Base clock speed
args.sys_clock = "2.4GHz"  # System clock speed
args.cacheline_size = 64
args.ruby = False
args.caches = True
args.l2cache = True
args.mem_size = "2GiB"  # Specify memory size in base 2
